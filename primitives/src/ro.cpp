...
void HashBasedRO::computeRO(const vector<byte> & input, int inOffset, int inLen, vector<byte> & output, int outLen) {
...
void HKDFBasedRO::computeRO(const vector<byte> & input, int inOffset, int inLen, vector<byte> & output, int outLen) {
